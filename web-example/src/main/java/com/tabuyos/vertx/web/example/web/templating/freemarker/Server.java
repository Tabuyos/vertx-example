 ...
 */
package com.tabuyos.vertx.web.example.web.templating.freemarker;
 ...
 *
 * <p>* Freemarker templates * Vert.x Web
 *
    ...
    router
        ...
        .handler(
            ctx -> {
              ...
              JsonObject data =
                  new JsonObject().put("name", "Vert.x Web").put("path", ctx.request().path());
