 ...
 */
package com.tabuyos.vertx.web.example.web.sqlclient;
  ...
  public void start(Promise<Void> startPromise) throws Exception {
    ...
    getProductTmpl =
        SqlTemplate.forQuery(
                client, "SELECT id, name, price, weight FROM products where id = #{id}")
            .mapTo(Row::toJson);
    addProductTmpl =
        SqlTemplate.forUpdate(
                client,
                "INSERT INTO products (name, price, weight) VALUES (#{name}, #{price}, #{weight})")
