 ...
 */
package com.tabuyos.vertx.web.example.web.templating.handlebars;
 ...
 *
 * <p>* Handlebars templates * Vert.x Web
 *
    ...
    router
        ...
        .handler(
            ctx -> {
              ...
              JsonObject data = new JsonObject().put("title", "Seasons of the year");
