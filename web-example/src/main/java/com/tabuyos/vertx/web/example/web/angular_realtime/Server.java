 ...
 */
package com.tabuyos.vertx.web.example.web.angular_realtime;
...
public class Server extends AbstractVerticle {
  ...
  public void start() throws Exception {
    ...
    // Create a mongo client using all defaults (connect to localhost and default port) using the
    // database name "demo".
    ...
    PropertyFileAuthentication authProvider =
    ...
    SockJSBridgeOptions options =
        new SockJSBridgeOptions()
            ...
            .addInboundPermitted(new PermittedOptions().setAddress("vtoons.login"))
    ...
    PropertyFileAuthorization authorizationProvider =
        PropertyFileAuthorization.create(vertx, "vertx-users.properties");
  ...
  private void listAlbums(Message<JsonObject> msg) {
    ...
    mongo.find(
        ...
        lookup -> {
          ...
          // now convert the list to a JsonArray because it will be easier to encode the final
