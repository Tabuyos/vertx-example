 ...
 */
package com.tabuyos.vertx.web.example.web.validation;
...
public class ValidationExampleServer extends AbstractVerticle {
  ...
  public void start() throws Exception {
    ...
    router
        ...
        .handler(
            (routingContext) -> {
              ...
              // or you can use the RequestParameters that contains parameters already parsed (and
              // maybe transformed)
    ...
    router
        ...
        .handler(
            ValidationHandler.builder(parser)
                .body(json(objectSchema().additionalProperties(stringSchema())))
                .build())
        .handler(
            (routingContext -> {
