...
public class OtherVerticle extends AbstractVerticle {
  ...
  public void start(Promise<Void> startPromise) throws Exception {
    ...
    // So we override the async version of start(), then we can mark the verticle as started some
    // time later
    ...
    vertx.setTimer(
        ...
        tid -> {
          ...
          // Now everything is started, we can tell Vert.x this verticle is started then it will
          // call the deploy handler
